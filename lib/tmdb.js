...
//}(this, function(XMLHttpRequest) {
  ...
  var tmdb = (function (){
    ...
    function getMovieCredits(movieid, error, success) {
      var method = 'movie/' + movieid + '/credits';
      _doRequest.call(this, method, null, error, success);
    }

    function getMovieImages(movieid, error, success) {
      var method = 'movie/' + movieid + '/images';
      _doRequest.call(this, method, null, error, success);
    }

    function getMovieKeywords(movieid, error, success) {
      var method = 'movie/' + movieid + '/keywords';
      _doRequest.call(this, method, null, error, success);
    }

    function getMovieVideos(movieid, error, success) {
