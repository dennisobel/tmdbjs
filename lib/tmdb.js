...
//}(this, function(XMLHttpRequest) {
  ...
  var tmdb = (function (){
     ...
     * @param {number} query.page - Min 1, max 1000
     * @param {string} query.language - Language on ISO 639-1 code
     * @param {boolean} query.include_adult - Flag for include adult content
     * @param {function} callback - Callback
     * @api public
     */
    function search(query, callback) {
      var method = 'search/multi';

      _doRequest(method, query, callback);
    }
     ...
     *
     * @param {object} query - Object
     * @param {string} query.query - Title
     * @param {number} query.page - Min 1, max 1000
     * @param {string} query.language - Language on ISO 639-1 code
     * @param {boolean} query.include_adult - Flag for include adult content
     * @param {number} query.year - Filter the results release dates
     * @param {function} callback - Callback
     * @api public
     */
